 ...
 */
final class Version20230329081946 extends AbstractMigration
{
...
//        $this->addSql('CREATE TABLE micro_post (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, text VARCHAR(1024) DEFAULT NULL, creat_at DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
//        $this->addSql('ALTER TABLE user_profile ADD user_id INT NOT NULL, ADD bio LONGTEXT DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE user_profile DROP user_id, DROP bio');
    }
}
